(function() {
	...
	jQuery(function() {
		...
		<table id="videoJStable" class="form-table">\
			<tr>\
				<th><label for="videojs-mpd">MPD Source</label></th>\
				<td><input type="text" name="videojs-mpd" id="videojs-mpd"><br>\
				<small>The location of the MPD source for the video.</small></td>\
			</tr>\
			<tr>\
